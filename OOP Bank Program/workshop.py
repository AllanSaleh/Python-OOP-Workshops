...
class BankAccount:
    ...
    def deposit(self, amount):
        try:
            ...
            print("Please type in an number representing the amount you want to deposit.")
    ...
    def withdrawal(self, amount):
        try:
            if(amount > 0):
                ...
                print("Please type in an number representing the amount you want to withdrawal.")
...
def runner():
    ...
    while True:
        ...
        if (choice == 1):
            ...
            balance = float(input("What is the balance for the account? "))
